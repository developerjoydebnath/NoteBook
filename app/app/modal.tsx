...
export default function ModalScreen() {
  ...
  if (loading && !isViewing) {
    return <View className="flex-1 justify-center items-center bg-white dark:bg-gray-900"><ActivityIndicator size="large" color="#3b82f6"></ActivityIndicator></View >
  }
    ...
    return (
      <ScrollView className="flex-1 bg-white dark:bg-gray-900">
        <View className="p-6">
            ...
            <View className="flex-1 mr-4 flex-row justify-between items-center w-full">
              ...
              <View className="flex-row flex gap-2">
                ...
                <TouchableOpacity
                  ...
                  className="bg-gray-100 dark:bg-slate-800 p-3 rounded-full"
                >
          ...
          <View className="h-[1px] bg-gray-100 dark:bg-slate-800 w-full mb-6" />
